QUnit.test("Check the settings hostname for a valid domain or IP address", function(assert){
    ...
    assert.ok(settings.hostname.match(matchesIP) || settings.hostname.match(matchesDomain) );
})